...
fn test<H: Digest + FixedOutput>(created_with_params: bool) {
    ...
    for _t in 0..nb_tests {
        ...
        let s_p: Vec<Data> = gen_items::<Blake2bVar, DATA_LENGTH>(&seed, nb_elements);
        ...
        let proof_item = P::<H>::from(proof.retry_counter, proof.search_counter, Vec::new());
