...
impl Params {
    ...
    pub fn new(lambda_sec: usize, lambda_rel: usize, n_p: usize, n_f: usize, mu: usize) -> Params {
        return Params {
            lambda_sec,
            lambda_rel,
            n_p,
...
mod tests {
        ...
        for l in lambdas {
            for &sp in &sps {
                for r in ratios {
                    ...
                    let mu = Params::min_mu(l, l, n_p, n_f);
                    let p = Params::new(l, l, n_p, n_f, mu);
                    params.push(p);
                }
            }
        }
    ...
    fn test_verify() {
        ...
        for _t in 0..nb_tests {
            ...
            let mu = Params::min_mu(lambda, lambda, set_size * np / 100, set_size * nf / 100);
            let params = Params::new(lambda, lambda, set_size * np / 100, set_size * nf / 100, mu);
